...
def convert_tf_generator(tf_G):
    ...
    # Convert kwargs.
    from stylegan3.training import networks_stylegan2
    ...
    _populate_module_params(G,
                            ...
                            r'mapping\.TPS(\d+)\.weight', lambda i: tf_params[f'mapping/Dense{i}/weight'].transpose(),
                            r'mapping\.TPS(\d+)\.bias', lambda i: tf_params[f'mapping/Dense{i}/bias'],
...
def convert_tf_discriminator(tf_D):
    ...
    _populate_module_params(D,
                            ...
                            r'mapping\.TPS(\d+)\.weight', lambda i: tf_params[f'Mapping{i}/weight'].transpose(),
                            r'mapping\.TPS(\d+)\.bias', lambda i: tf_params[f'Mapping{i}/bias'],
                            r'b4\.conv\.weight', lambda: tf_params[f'4x4/Conv/weight'].transpose(3, 2, 0, 1),
                            r'b4\.conv\.bias', lambda: tf_params[f'4x4/Conv/bias'],
                            r'b4\.TPS\.weight', lambda: tf_params[f'4x4/Dense0/weight'].transpose(),
                            r'b4\.TPS\.bias', lambda: tf_params[f'4x4/Dense0/bias'],
