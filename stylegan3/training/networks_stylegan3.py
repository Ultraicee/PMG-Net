...
class SynthesisLayer(torch.nn.Module):
    ...
    def forward(self, x, w, noise_mode='none', force_fp32=False, update_emas=False):
...
class SynthesisNetwork(torch.nn.Module):
    def __init__(self,
                 ...
                 channel_base=16 << 8,  # Overall multiplier for the number of channels.
                 channel_max=64,  # Maximum number of channels in any layer.
                 num_layers=3,  # Total number of layers, excluding Fourier features and ToRGB.
                 ...
                 num_fp16_res=2,  # Use FP16 for the N highest resolutions.
