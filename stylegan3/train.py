...
@click.option('--cbase', help='Capacity multiplier', metavar='INT', type=click.IntRange(min=1), default=16 << 8,
              show_default=True)
@click.option('--cmax', help='Max. feature maps', metavar='INT', type=click.IntRange(min=1), default=32,
              show_default=True)
...
@click.option('--kimg', help='Total training duration', metavar='KIMG', type=click.IntRange(min=1), default=2000,
              show_default=True)
...
def main(**kwargs):
    ...
    c.G_kwargs = dnnlib.EasyDict(class_name=None, z_dim=16, w_dim=16, mapping_kwargs=dnnlib.EasyDict())
    ...
    c.G_kwargs.mapping_kwargs.num_layers = 1
